---
title: "From Reading About Parenting to Actually Doing It"
pubDate: 2026-01-07
description: "How I built a curriculum to turn fifteen parenting books into actual practice"
tags: ["parenting"]
---
...
- **No praise, rewards, or time-out.** I drew on Alfie Kohn's critique of rewards, Faber's alternatives to punishment, and NVC's approach to requests. The curriculum uses descriptive noticing, co-regulation, and natural outcomes instead.

- **Capacity-first design.** I designed for the hard case: tired, ND, three kids under six. This is basically the curb-cut effect — what works for constrained situations tends to work for everyone. Every step has a "The One Thing" escape hatch, a fridge card, and an "if you only have 10 seconds" option.

- **70% standard.** Better to complete imperfectly than abandon. The curriculum explicitly builds in permission to be "good enough" — because perfectionism prevents practice.
...
[The curriculum](/parenting/) has 16 steps organized into 6 phases, from "Regulated Parent, Safer Home" through "Parent Sustainability." Each step includes:

- **"The One Thing"** — if you read nothing else, read this
- **Three tracks** — parent regulation, child skill, environment tweak — with permission to pick just one
- **Quick Reference Card** — printable one-pager for the fridge
- **ND adaptations** — body-based alternatives, soft numbers, explicit escape hatches

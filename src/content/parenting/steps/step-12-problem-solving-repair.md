---
title: "Simple Problem-Solving & Repair"
step: 12
phase: 4
...
**If you only have...**
- **10 seconds:** After you mess up, say: "I'm sorry. That wasn't okay."
- **5-10 minutes:** Try one problem-solving conversation with your 6-year-old
- **10-15 minutes:** Do one family check-in at the end of the week
...
1. **They believe they can affect outcomes.** This comes from having their ideas heard and seeing solutions work.

2. **They've experienced relationship repair.** Ruptures (fights, yelling, disappointment) are inevitable. What matters is what happens AFTER.
...
- Your 6-year-old develops an internal "I can figure this out" muscle
- Your twins learn conflict scripts before they need them
- YOU model that messing up doesn't mean failure
- Everyone in the family knows: "We fix things here."

---

## Track 1 – Child Skill: Problem-Solving (6-Year-Old) + Practice Runs (Twins)
...
### For Your 6-Year-Old: Collaborative Problem-Solving

Pick a SMALL, RECURRING problem to start. Not "you never listen" — something specific like:
- Morning battles about getting dressed
- Fights over screen time ending
- Bedtime delays
...
- Try problem-solving while walking, drawing together, or playing with LEGO
- Let them draw their ideas instead of saying them

#### Example Scripts for 6-Year-Old
...
### For Your 2-Year-Old Twins: Practice Runs and Micro-Choices

They're too young for collaborative problem-solving. Instead, build skills through:

#### Micro-Choices (Whenever Possible)
...
#### Practice Runs (Before the Hard Moment)
...
## Track 2 – Parent Mini-Practice: One Deliberate Repair
...
- Apologizing is brave, not weak
- Love survives conflict
- They're not responsible for your emotions
...
- Physical repair counts: A long hug, extra snuggle time, their favorite activity together
- Written repair: A little note for your 6-year-old
- The key is RECONNECTION, not specific words

If you're prone to excessive guilt:
- One repair, done simply, is enough
- You don't need to grovel or over-explain
- Model healthy, boundaried apology

**If naming your feelings is hard (alexithymia is common in ND parents):**
- Use simple, broad words: "My brain was overloaded," "My body felt too buzzy," or "I was too full"
- It's okay to skip naming the feeling sometimes and just say, "I got too loud. I'm sorry. I'm working on it."

---

## Track 3 – Environment Mini-Project: Weekly Family Check-In
...
- "What went well: time with grandma / screen time / playing outside?"
- "What was hard: mornings / bedtime / sharing toys?"

If you or your kids are sensory-sensitive:
- Keep lights gentle, no background TV
- Allow fidgets, drawing, or movement during check-in
...
- Combine it with something fun (dessert, game time after)
- Try 1:1 check-ins instead of whole family
- Drop it and try again in a few months
...
- "Your sister is crying. What could help her feel better?"
- Not forced "say sorry" — but coached toward connection
- If they're still flooded, wait. Repair comes after calm.

For the hurt child:
- "That hurt. Your brother is going to check on you."
- They don't have to accept the apology
- "It's okay if you're still upset."
...
### "I apologize but then I feel guilty for hours"
...
### "My 6-year-old doesn't want to problem-solve"

Possible reasons:
- She's flooded (wait until calm)
- She doesn't believe you'll listen (build trust over time)
- She doesn't have ideas (that's okay — offer some)
- She doesn't like talking (try while doing an activity, walking, or drawing)
- She feels "problem-solving" is a demand (especially PDA kids). Try framing it as "experimenting" or "designing a new morning routine" instead of "solving a problem."

Don't force it. Try once, drop it, try again another day.

### "The twins don't understand practice runs"
...
### "Family check-in feels forced/awkward"

It often does at first. Common fixes:
- Keep it shorter
- Do it during an existing routine (meal, car ride)
- You go first to model
- Use objects: "Put a pom-pom in the happy jar for something good, problem jar for something hard"

### Partner Angle: Repair Between Parents
...
See the **[Co-Parenting Guide](/parenting/companions/co-parenting-guide/)** for more on partner repair.
...
- **How to Talk So Kids Will Listen** (Faber & Mazlish), Chapter 4 — Encouraging autonomy and problem-solving together
- **Good Inside** (Becky Kennedy), Chapter 8 — Repair after rupture: why it matters and how to do it
- **Siblings Without Rivalry** (Faber & Mazlish), Chapter 6 — Problem-solving meetings; letting kids work it out
...
### Practice Runs (2-Year-Olds)

- "Let's practice saying 'my turn'!"
- "When the music stops, we walk to the car. Let's try!"
- Keep it 30 seconds, make it fun
...
❌ No excessive guilt  
❌ No demanding they accept

### Weekly Check-In

10-15 min, 3 questions:
- What went well?
- What was hard?
...
**If core still feels shaky:**
Loop back to Steps 1–6 and live there. There's no deadline.

---

### Other Options

**Loop back faster:** Start at Step 1 and move faster (3-4 days per step instead of a full week). Notice what's easier now.

**One skill per month:** Pick the step that feels most alive (maybe Step 4's special time or Step 10's boundaries) and stay there for a whole month.

There's no graduation. This is a toolkit you circle through as your kids (and you) grow.

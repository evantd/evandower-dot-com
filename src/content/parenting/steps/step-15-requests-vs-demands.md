...
**If you only have...**
- **10 seconds:** Before speaking, ask yourself: "Am I okay if they say no?"
- **1-2 minutes:** Catch one demand, restate it as a request
- **15-20 minutes once this step:** Create the visual request board
...
- Daily friction decreases (you're not constantly triggering resistance)
- Kids feel more respected (and become more cooperative)
- You stop the power-struggle cycle
- Your 6-year-old learns how to ask for what she needs (not demand)
- Everyone's nervous system stays calmer
...
- "That was a request, not a demand. You can say yes, no, or suggest something else."
- "I'm asking because I want you to want to help, not because you have to."

When she demands something, coach gently:
- "That sounded like a demand. Can you try asking?"
- "[6-year-old], I want to say yes to you. It's easier when you ask instead of tell."

### When She Demands from the Twins

This is a natural opportunity:
- "Sounds like you're telling [twin] what to do. She might cooperate more if you ask."
- "Try 'Would you...' instead of 'Give me...'"

### ND Adaptation

**For PDA profiles:**
- PDA kids **especially** need requests, not demands
- Any perceived demand triggers automatic resistance (it's neurological, not defiance)
- Frame everything as choice: "Would you like to... or...?"
- Accept unconventional "yes" responses (a grunt, a nod, doing it 5 minutes later)

**For sensory/processing differences:**
- Give processing time after requests (5-10 seconds of silence)
- One request at a time, not stacked
- Visual cues can help (point, gesture, picture)

**For your 6-year-old:**
- She may need even more autonomy than typical
- Offer "no" as a valid option, then problem-solve together
- "You can say no. And then we'll figure out what to do about [the underlying need]."
...
- "Would you like to help set the table?" (genuinely okay if no)
- "Can you bring me the napkins?" (not urgent)
- "Would you be willing to pick up these two toys?" (small ask)
...
**DON'T:**
- Punish, lecture, or guilt-trip (then it was a demand)
- Immediately escalate ("Fine, THEN no screen time!")
- Withdraw affection or connection

**DO:**
- Get curious: "Oh, you don't want to. What's going on?"
- Offer information: "If we don't leave now, we'll be late. I don't want to feel rushed."
- Problem-solve: "Okay, what would work for you?"
- Accept: "Okay, not right now. I'll ask again in 5 minutes."
...
- Did I make a true request today?
- What happened when I did?
- Did any of my "requests" turn out to be demands in disguise?
...
- "We're making a poster about asking nicely. What are some good ways to ask?"
- Let her decorate it
- She can add requests she wants to practice with the twins
...
- "Can you try asking [twin] instead of telling?"
- "She might say yes if you ask nicely."
- "Try: 'Would you give me a turn?'"
...
**What you can do:**
- Model request language when you want something from them
- Narrate their attempts: "[Twin A] wants the truck. [Twin A], can you try 'please'?"
- Celebrate any approximation of asking vs. grabbing
...
- You notice when your "request" was actually a demand (because you reacted badly to "no")
- Your 6-year-old starts using request language sometimes
- Daily friction feels slightly lower
...
Respond with:
- Curiosity: "You're saying no a lot lately. What's going on?"
- Problem-solving: "Okay, no to that. What would work for you?"
- Limit when needed: "I hear you don't want to. This one isn't optional, but I want to understand what's hard about it."

### "This feels manipulative — like I'm tricking them"

The difference between manipulation and NVC is **intention**.

**Manipulation:** Using request language to get compliance, but still punishing refusal
**True request:** Genuinely prioritizing connection over compliance
...
If they're curious: share what you're learning.
If they're not: keep practicing anyway. Your children will learn from both of you, and your modeling still matters.
...
- Offer "no" explicitly: "You can say no. I just want to know what you need."
- Indirect requests: "I wonder if anyone wants to help me carry groceries..." (not directed at them)
- Wait longer for processing
- Accept delayed compliance (they do it 10 minutes later, on their terms)
- Reduce the total number of asks per day
...
- **Nonviolent Communication** (Rosenberg), Chapters 6-7 — Requests vs demands; making requests that enrich life (the core chapters for this step)
- **How to Talk So Kids Will Listen** (Faber & Mazlish), Chapter 2 — Engaging cooperation without commands
- **Unconditional Parenting** (Alfie Kohn), Chapter 7 — Moving beyond control
...
| Your Reaction | What It Was |
|---------------|-------------|
| Punish, guilt-trip, withdraw | DEMAND |
| Get curious, negotiate, accept | REQUEST |

### What Makes a True Request

1. **Positive** — What you WANT (not what you don't want)
2. **Specific** — Concrete action they can do
3. **Present moment** — Doable now
4. **Okay with "no"** — No punishment follows

### Common Transformations

| Demand | Request |
|--------|---------|
| "Clean up NOW." | "Would you be willing to put the blocks away?" |
| "Say sorry!" | "Would you check if she's okay?" |
| "Stop crying." | "Can I sit with you?" |
| "Get your shoes on!" | "Can you get your shoes before we leave?" |

### When They Say No

1. Get curious: "What's going on?"
2. Problem-solve: "What would work for you?"
3. Accept: "Okay, not now."

### Your Daily Practice

Replace ONE demand with a true request. Notice what happens.

---
title: "Descriptive Noticing (Replacing Praise)"
step: 9
phase: 3
...
**If you only have...**
- **10 seconds:** Describe one thing you see your child do today instead of evaluating it
- **1-2 minutes:** Catch yourself before "good job!" and describe what they did instead
- **20-30 minutes once this step:** Lock in your bedtime routine
...
- **It's evaluative** — kids learn to look to you for approval
- **It's vague** — they don't know what they did well
- **It can feel like pressure** — "Am I still 'good' if I don't do it next time?" (For PDA kids, even praise can feel like pressure to perform again.)
- **It can fuel masking and perfectionism** — especially for ND kids who already feel "too much" or "not enough," praise can make them perform for approval and hide their real selves

Descriptions work differently:

- **They're information** — kids learn what mattered
- **They build intrinsic motivation** — the focus is the action, not your approval
- **They feel specific** — "You noticed I did THAT"
...
- Reflexively saying "good job" to everything
- Creating approval-seeking patterns
- Accidentally teaching that your evaluation is what matters

You start:
- Noticing specific things your kid does
- Communicating that YOU noticed
- Building their sense of competence (not just compliance)

---

## Track 1 – Child Skill: Descriptive Noticing
...
1. **Describe the action** — What did they do?
2. **Describe the effect** — What happened as a result?
3. **(Optional, 6-year-old+) Name a character trait** — What quality does this show?
...
- For 6-year-old: "You took one bite. You checked it out."
- For 2-year-old: "You licked it." (no comment on good/bad)
...
- Enthusiasm in TONE is great — "You DID it!"
- Keep descriptions very simple — just action + result
- No need for character words at this age
...
- More detailed observations welcome
- Optional: add a character trait ("That's persistence," "That shows patience")
- Character words help her build an internal vocabulary for her qualities

**Twin dynamics:**
- Describe what each twin did individually — avoid comparing
- "Lila put the blocks in. And you got the cars!"
- If one copies the other: just describe both actions
...
- Quiet noticing: "I saw that." (calm, brief)
- Nonverbal: smile, thumbs up, small nod
- Later mention: "I noticed earlier you shared with Lila. That was kind."
...
## Track 2 – Parent Mini-Practice: Replace One "Good Job" Per Day
...
1. Notice the urge to say "good job!" or "well done!" or "good girl/boy!"
2. Pause.
3. Ask yourself: "What did they actually DO?"
4. Describe that thing out loud.
...
- You don't have to sound like a parenting book
- "You did the thing. Nice." counts.
- Deadpan descriptions are fine

If tracking "one per day" feels like pressure:
- Just notice when you say "good job." That's the awareness. No quota needed.

---

## Track 3 – Environment Mini-Project: Lock In Bedtime Routine with Stories
...
1. **Map your current bedtime** — What happens? In what order? Where do meltdowns occur?

2. **Choose a consistent sequence** — Same steps, same order, every night. Example:
   - Bath (or skip bath)
   - Jammies
   - Teeth
   - Stories (1-2 books or 10-15 min)
   - Song or quiet time
   - Lights out

3. **Add the "grit sandwich" (optional and skip it if it ramps them up):**
...
4. **Reduce decisions** — Pick jammies, books, etc. in advance. Fewer decisions at bedtime = fewer battles.
...
- Connection time (co-regulation)
- Predictable endpoint ("After stories, lights out")

### If Bedtime Is Currently a Disaster

Start smaller:
- Just add ONE story before lights out
- Don't overhaul the whole routine yet
- Build the story habit, then add structure around it
...
- "You both made space. Now you're both playing."
- "You waited. She got her turn. Now it's yours."

**When one helps the other:**
- "You helped Lila. She figured it out."
- Not: "Good helping!" (too evaluative)
- If one child often ends up in the "helper" role, still describe **both** kids' actions so it doesn't become a one-sided identity.

**Avoid comparative descriptions:**
- Not: "You shared better than yesterday" or "Your sister did it faster"
- Just describe what THIS child did right now

**Describing the dynamic:**
- "You two figured that out together."
- "You made a deal. That worked."
...
### "This feels cold or withholding"
...
### "I keep forgetting and saying 'good job' anyway"
...
### "My kid seems confused when I describe instead of evaluate"
...
- "You put the block on top."
- "You're using the red crayon."
- "You walked over here."

It doesn't have to be profound. Noticing is enough.

### "Why does this feel safer for ND kids?"
...
### "What if grandparents/teachers still use stickers or time-out?"

See [External Adults Handout](/parenting/companions/external-adults-handout/) for scripts and "agree to disagree" ideas.
...
- **How to Talk So Kids Will Listen** (Faber & Mazlish), Chapter 5 — Praise: describing what you see, describing what you feel, summing up with a character word
- **Unconditional Parenting** (Alfie Kohn), Chapter 5 — Why praise is a form of control; what to do instead
- **Nonviolent Communication** (Rosenberg), Chapter 3 — Observation without evaluation (the same skill)
...
> Describe action → Describe effect → (Optional: character word)
...
| "Good drawing!" | "You used lots of colors. I see circles." |

### Daily Practice

Replace ONE "good job" per day with a description.

Notice the pause. That's the skill.

### Environment Task

Lock in consistent bedtime routine with stories. Same steps, same order.

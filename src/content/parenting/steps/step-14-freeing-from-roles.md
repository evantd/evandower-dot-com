---
title: "Freeing Children from Roles"
step: 14
phase: 5
...
**If you only have...**
- **10 seconds:** Catch a label in your head. Add "today" or "right now."
- **1-2 minutes:** Recall one moment that contradicts a child's stuck role
- **15-20 minutes once this step:** Start a "special moments" list for each child
...
- "I remember when you were three and you shared your last cookie with that crying baby at the park."
- "Remember last week when you waited so patiently at the doctor's office? That was you."
- "I saw you help your sister when she was stuck. You can be so kind."
...
- Not weaponize traits as criticism
...
You can use:
- A note on your phone (one per child)
- Index cards in your wallet
- A page in your journal
- A shared document with your partner

### What to Collect

For your 6-year-old, collect moments when she:
- Was patient (even briefly)
- Shared without being asked
- Showed kindness to the twins
- Managed frustration (even imperfectly)
- Was independent
- Asked for help (if her role is "doesn't need anything")

For each twin, collect moments when they showed the OPPOSITE of their emerging role:
- "Loud one" was calm and focused
- "Quiet one" was energetic and assertive
- "Difficult one" went with the flow
- "Easy one" expressed a need
...
- *She shared her crackers without being asked*
- *She played by herself for 10 minutes peacefully*
- *She said "I'm frustrated" instead of hitting*
...
- Add to the same document
- Text each other moments: "Just saw [twin] be so gentle with the cat!"
- Use these in front of the child: "Daddy told me how you helped him clean up yesterday..."
...
- Puts unfair pressure on her
- Excuses behavior in the twins that could be addressed
- Locks everyone into complementary positions
...
2. **Don't force her into "helper" role:**
...
3. **Let each twin be multidimensional:**
...
- Give in because "they're little"
- Be patient because "you're the big kid"
- Help because "you're the oldest"
...
- Grandma: "He's such a handful!"
- You: "He has a lot of energy today."
...
- Labels create expectations that become self-fulfilling
- Labels close off possibility for change
- Labels make the child feel stuck
...
- Model different language in their presence
- Gently reframe: "She has a lot of energy" instead of agreeing with "wild child"
- Privately counter-program with your child: "Grandma called you shy, but I saw you introduce yourself to that kid at the park. You were brave."

See the [External Adults Handout](/parenting/companions/external-adults-handout/) for scripts on navigating grandparents, teachers, and other caregivers who use different methods.

### "I don't know what my child's 'role' is"

Look for patterns in how you describe them to others:
- "She's my [adjective] one"
- "He always [behavior]"
- "She never [behavior]"
...
- Interests: "Maya loves music. Noah loves trucks."
- Preferences: "Maya prefers quiet play. Noah likes rough-and-tumble."
- Current states: "Maya is tired right now. Noah is energized."
...
- **How to Talk So Kids Will Listen** (Faber & Mazlish), Chapter 6 — Freeing children from playing roles (the core chapter for this step)
- **Siblings Without Rivalry** (Faber & Mazlish), Chapter 5 — Siblings in roles; how roles come in pairs
- **Unconditional Parenting** (Alfie Kohn), Chapter 4 — How labels shape identity and behavior

---
title: "Emotion Coaching + Calm-Down Strategies"
step: 6
phase: 2
phaseName: "Connect & Name Feelings"
---

> 📋 **[Quick Reference Card](/parenting/cards/week-06-card/)** — Print this for the fridge
...
| Track | What | Time |
|-------|------|------|
| **1. Child Skill** | Emotion coaching sequence + calm-down strategies | During meltdowns |
| **2. Parent Practice** | Yell-Less Plan | 10 min setup, ongoing |
| **3. Environment** | Create calm-down corner or kit | 30 min setup |
...
| **Rock together** | Sit with them on your lap, rock slowly |
| **Sing** | Simple, repetitive song in calm voice |
| **Lovey/comfort object** | "Here's your bunny" |
| **Movement** | Pick up and sway, walk together, bounce |
| **Sensory** | Soft blanket, textured toy, cold water on hands |
...
| **Count together** | Slow counting to 10, or backwards from 5 |
...
> **Buddhist Lens (Optional):** Co-regulation is *being with* suffering, not fixing it. Brave Parenting uses the river metaphor: when we dam emotions by fixing, shushing, or distracting, they back up. When we let the river run — staying present while the storm passes — emotions move through naturally. This isn't passive; it's the hardest kind of bravery. See [Buddhist Lens](/parenting/companions/buddhist-lens/) for more.
>
...
- **Sensory-friendly setup:** Low lighting, no fluorescent bulbs; soft textures only; minimal visual clutter
- **Noise management:** Include noise-reducing headphones; locate away from loud areas
- **Proprioceptive options:** Add weighted lap pad, resistance bands, or chew toys
- **Visual supports:** Use picture cards for strategies rather than written lists

### Twin Dynamics

- Consider: two corners, or two kits, or one shared space with two zones
- "You both get your own calm-down corner"
- Model taking turns if they want the same space
...
- "That was hard. Everyone was upset."
- Problem-solving comes later, when they're regulated
...
- Not yell
- Not leave (unless you need to for safety)
- Keep your body relatively relaxed
...
- Offering space explicitly: "I'll be right outside. Call me when you want me."
...
- **The Whole-Brain Child** (Siegel & Bryson), Chapters 3-4 — "Connect and redirect" and "move it or lose it" strategies for co-regulation
- **How to Talk So Kids Will Listen** (Faber & Mazlish), Chapter 1 — Granting wishes in fantasy; giving feelings a name
- **Good Inside** (Becky Kennedy), Chapter 4 — Co-regulation scripts and why time-in works better than time-out
...
|-------------|------------|
| Hug, rock, sing, lovey | Breathing, calm-down corner |
| Movement, sensory | Squeeze/push, draw it |

### Yell-Less Plan

1. Mantra (e.g., "This is not an emergency")
2. Visual reminders in trigger spots
3. Escape route (water on face, step outside)

### Calm-Down Corner

Soft things + fidgets + headphones. **Introduce when calm, not during meltdown.**

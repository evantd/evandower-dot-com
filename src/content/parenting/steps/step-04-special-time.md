---
title: "Child-Directed Play + Special Time"
step: 4
phase: 2
...
| Track | What | Time |
|-------|------|------|
| **1. Child Skill** | 10-15 min daily special time per child | 10-15 min/child/day |
| **2. Parent Practice** | Phone away, count urges to direct/teach | During special time |
| **3. Environment** | Consistent after-school/childcare transition ritual | Once to set up |
...
> **Waldorf Lens (Optional):** Waldorf calls this honoring "play as the child's work." When you follow their lead without teaching or directing, you're respecting the developmentally complete mode of learning for young children. See [Waldorf Lens](/parenting/companions/waldorf-lens/) for more.
...
| You DO | You DON'T |
|--------|-----------|
| Follow their lead completely | Suggest activities |
| Narrate what you see (sportscasting) | Teach or correct |
| Mirror their expressions and energy | Ask leading questions |
| Stay present and attentive | Check your phone |
| End with a transition warning | End abruptly |
...
|---|---------------------|-------------------|
| **Duration** | 10 minutes is plenty | 15 minutes, can stretch to 20 |
| **What they might choose** | Sensory play, stacking/knocking down, books, being chased | Pretend play, art, building, games, imaginative scenarios |
| **How to follow lead** | Join what they're doing, mirror actions | Ask "What should I do?" then do exactly that |
| **If they want you to DO something** | Do it their way, even if "wrong" | Be the incompetent bumbling adult if they want |
| **Sportscasting sounds like** | "You're pouring. Pour, pour, pour." | "You decided the dragon should fly there." |
| **Special time logistics** | One twin at a time if possible; if not, sit between and follow both | One-on-one is ideal |
...
- You'll be surprised how often the urge arises
- Noticing the urge builds the muscle to resist it
- Over time, the urges decrease

### ND Adaptation

If counting feels too meta:
- Just notice when you catch yourself directing
- No judgment — "Oh, there I go" — then return to following
- Or: Have a physical counter (click counter, move a bead)
...
**10-15 min special time per child, they lead completely**

**Good enough:** Special time with **at least one child**, 3 days this week (even 5-10 minutes counts)

### Special Time Rules

| You DO | You DON'T |
|--------|-----------|
| Follow their lead | Teach/correct |
| Sportscast: "You put the block there" | Evaluate: "Good job!" |
| Phone away | Ask leading questions |
| Warn before ending | End abruptly |

### Sportscasting

Describe what you see, don't evaluate.
- "You're using blue." (not "Beautiful!")
- "You built it tall." (not "Good job!")

### After-School Ritual

1. Arrival cue (shoes off)
2. Same snack spot
3. 15-30 min decompress (no demands)

### Sibling Jealousy

"This is [sibling]'s special time. Yours is at [time]."

### Mastery

Follow their lead 15 minutes without directing or correcting.
